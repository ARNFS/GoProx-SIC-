...
public class CallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentUserId =
                intent.getStringExtra("currentUid");

        otherUserId =
                intent.getStringExtra("otherUserId");

        remoteUserName =
                intent.getStringExtra("remoteUserName");

        serviceTitle =
                intent.getStringExtra("serviceTitle");
        ...
        localUid =
                Math.abs(currentUserId.hashCode())
                        % 100000
                        + 1;
    ...
    private void initViews() {
        ...
        flRemote =
                findViewById(R.id.flRemoteVideo);

        flLocal =
                findViewById(R.id.flLocalVideo);
        ...
        btnEndCall =
                findViewById(R.id.btnEndCall);

        btnSpeaker =
                findViewById(R.id.btnSpeaker);

        tvRemoteName =
                findViewById(R.id.tvRemoteName);

        tvCallTimer =
                findViewById(R.id.tvCallTimer);
    ...
    private void playConnectTone() {
        ...
        try {
            ...
            if (connectTonePlayer != null) {
                ...
                connectTonePlayer.setOnCompletionListener(
                        mp -> {

                            mp.release();

                            connectTonePlayer = null;
                        }
                );
            }
    ...
    private void playDisconnectTone() {
        ...
        try {
            ...
            disconnectTonePlayer =
                    MediaPlayer.create(
                            this,
                            R.raw.call_disconnect
                    );
            ...
            if (disconnectTonePlayer != null) {
                ...
                disconnectTonePlayer.setOnCompletionListener(
                        mp -> {
    ...
    private void stopAllMedia() {
        ...
        try {
            ...
            if (connectTonePlayer != null) {
                ...
                if (connectTonePlayer.isPlaying()) {
                    connectTonePlayer.stop();
                }

                connectTonePlayer.release();
    ...
    private void initAgora() {
        ...
        try {
            ...
            /*
             * Prefer image quality when bandwidth is limited.
             */
            videoConfig.degradationPrefer =
                    VideoEncoderConfiguration.DEGRADATION_PREFERENCE.MAINTAIN_QUALITY;

            /*
             * Keep SDK-managed minimum bitrate.
             */
            videoConfig.minBitrate =
    ...
    private void joinChannel() {
        ...
        try {
            ...
            opts.publishCameraTrack =
                    true;

            opts.publishMicrophoneTrack =
                    true;

            opts.autoSubscribeAudio =
                    true;

            opts.autoSubscribeVideo =
                    true;
    ...
    public void onRequestPermissionsResult(
        ...
        if (requestCode == PERM_REQ) {
            ...
            if (allGranted) {
                ...
                Toast.makeText(
                        this,
                        "Camera and microphone are required for calls",
                        Toast.LENGTH_SHORT
                ).show();
